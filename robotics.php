...
<body><!-- oncontextmenu="return false"-->
  ...
  <div class="section_heading robotics_head">
	<div class="container">
      <div class="row">
  	...
  	<div class="container">
    	<div class="row">
  			<div class="col-md-7 animated wow fadeInLeft">
    			<p class="text-justify">IndyBots Principle business is to offer complete solutions on turnkey basis to its customers, typically consisting user requirement capturing & understanding of customer need, engineering of the solution into implementable system design and Deployment, Installation, Commissioning & Production support at Customer site .Project Management and Process development functions required during the project lifecycle.
...
The Next Generation. However much these robots capture our imagination, such robots still only inhabit Science Fiction. People still haven’t been able to give a robot enough ‘common sense’ to reliably interact with a dynamic world.

Well it is a system that contains sensors, control systems, manipulators, power supplies and software all working together to perform a task.</p>
    		</div><!--col-md-7-->
